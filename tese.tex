...
%Capitulos
\include{introducao} %overview AL, (ELM?)
% % \include{al} %estrats, experimentos de exemplo, limitações (que vou superar)
% % \include{elm} %review; instab. etc.; p/ ap. interativo; exps mostrando runtime
% % \include{SG-multi}
% % \include{conclusao}
