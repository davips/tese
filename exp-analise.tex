...
É possível observar, na Figura \ref{curvasdesvio}, que as estratégias ATUmah, HTUmah
e EERent detêm os menores valores de desvio padrão durante a maior parte do
...
% Existem algumas combinações menos favoráveis dentre as bases e os algoritmos selecionados.
% Algumas delas são perceptíveis na Figura \ref{treebadleas}.
% A árvore indica a contagem de derrotas de cada algoritmo de acordo com a acurácia
% passiva balanceada.
% Uma baixa proporção de exemplos por atributos ($\frac{\#exemplos}{\#atrib.} \leq 8$),
% por exemplo, desfavorece C4.5w e CIELM mais fortemente.
