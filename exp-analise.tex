...
\begin{itemize}
 ...
 \begin{itemize}
  ...
  \item SGmulti vence Rnd e Mar além de DWeuc;
...
É possível avaliar o comportamento das estratégias ao longo das consultas por meio
de curvas de aprendizado.
A acurácia balanceada média para todas as bases e aprendizes tem a forma de uma
típica curva de aprendizado ativo.
As curvas das diferentes estratégias são comparadas na Figura \ref{ALCs}.

% \begin{figure}
% \begin{center}
% \begin{tikzpicture}[scale=1]
% \begin{axis}[xlabel=consultas, ylabel=posição no ranqueamento,
% legend style={at={(1.5,0.5)}, anchor=east}]
% % \addplot[gmark=none] file[y=Rnd] {kappabestRank.plot};   % Here is the data file
% % \addplot[color=green,mark=none] file {kappabestRank.plot};
% % \addplot table[y = Rnd] from \datatable;
% % \addplot[blue!80!black, mark=none] table [y=Rnd] {kappabestRank.plot};
% \addplot table [y=Rnd, mark=star] {kappabestRank.plot};
% \addplot table [y=Clu] {kappabestRank.plot};
% \addplot table [y=Mar] {kappabestRank.plot};
% \addplot table [y=EERacu] {kappabestRank.plot};
% \addplot table [y=SGmulti] {kappabestRank.plot};
% \addplot table [y=DWeuc] {kappabestRank.plot};
% \addplot table [y=TUman] {kappabestRank.plot};
% \addplot table [y=ATUman] {kappabestRank.plot};
% \addplot table [y=ALUman] {kappabestRank.plot};
% \addplot table [y=TUmah] {kappabestRank.plot};
% \addplot table [y=ATUmah] {kappabestRank.plot};
% \addplot table [y=ALUmah] {kappabestRank.plot};
% \legend
% {Rnd, Clu, Mar, EERent, EERacu, \textbf{SGmulti}, DWeuc, TUman, \textbf{ATUman}, \textbf{ALUman}, TUmah, \textbf{ATUmah}, \textbf{ALUmah}};
% \end{axis}
% \end{tikzpicture}
% \end{center}
% \end{figure}
...
sem a separação por aprendiz feita na Seção \ref{constante}.

% \afetrpage{\clearpage\begin{landscape}
