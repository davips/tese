...
O algoritmo de aprendizado mais adequado para um dado problema normalmente não
é conhecido até que se tenha um conjunto de treinamento suficientemente grande para
...
sem a definição do aprendiz a ser adotado.
Por isso, a comparação requer a avaliação do desempenho associado a diferentes classificadores.
A forma escolhida para avaliação do desempenho geral foi considerar cada par
...
para um bom desempenho em classificadores variados.
...
pois ela evita que classificadores inadequados prejudiquem o desempenho dos
demais.
...
\input stratsALCKappaFriedRFRedux
...
pode chegar a se inverter, como é o caso de EERacu e Clu com os classificadores
CIELM e 5NN.
