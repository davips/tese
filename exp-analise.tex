...
% Assim, as estratégias propostas podem ser consideradas competitivas em termos de desempenho preditivo.
Assim, as estratégias propostas podem ser consideradas superiores à não aplicação
de aprendizado ativo (Rnd) e a algumas estratégias relevantes apesar de ATUman e ATUmah não
terem superarado suas versões originais.
