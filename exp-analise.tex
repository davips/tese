...
Apesar dos valores de desvio padrão serem muito próximos para haver diferenças estatisticamente
significativas, é possível observar, na Figura \ref{curvasdesvio}, que as estratégias ATUmah e GATUmah
...
% Fried está dizendo não haver diferença, p=1

Finalmente, pode-se concluir, segundo o conjunto de bases e algoritmos utilizados,
que a versão agnóstica proposta (ATUmah) é viável na prática.
