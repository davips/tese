...
Aprendizado ativo é o estudo de algoritmos interativos que procuram fazer uso racional dos dados
por meio de perguntas \citep{series/synthesis/2012Settles}.
A pergunta do cenário mais comum na literatura,
num dado momento durante o aprendizado,
é ``\textit{Qual é o rótulo do exemplo $\bm{x}$?}''.
...
\ano{basilar pois é em oposição à motivação imediata e específica}
