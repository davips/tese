...
\subsection{Enviesada para o balanceamento}\label{gatu}
...
Optou-se pelo grau de balanceamento das classes do conjunto de exemplos rotulados.
Se a última consulta melhora o balanceamento, então mantém-se a estratégia vigente;
do contrário, passa a vigorar a outra.
O grau de balanceamento é calculado pela entropia normalizada da distribuição de classes.
