...
% This criterion disrupts with the binary decision model underlying its
% theoretical background inspiration and may be more adequate to
% select instances from the disagreement area.
