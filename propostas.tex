...
\section{Adaptações de Classificadores}
\subsection{IELM}
\subsection{EIELM}
\subsection{CIELM}
\subsection{nintera}
...
\subsubsection{DWLaU}% - Amostragem ponderada por densidade e utilidade do rótulo}

\subsubsection{DWLoU}% - Amostragem ponderada por densidade e utilidade local}

\subsubsection{DWLoLaU}% - Amostragem ponderada por densidade e utilidade local do rótulo}
 \blue{consertar e rodar DWLoLaU, caso DWLoU e DWLaU sejam bons; excluir tópico caso
negativo}
