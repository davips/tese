...
% \newcommand{\ing}[1]{\textit{#1}\xspace}
\newcommand{\blue}[1]{\textcolor{blue}{#1}\xspace}
\newcommand{\red}[1]{\textcolor{red}{#1}\xspace}
\newcommand{\green}[1]{\textcolor{dark-green}{#1}\xspace}

\newcommand{\engl}[2]{\emph{#1}\footnote{\textit{#2}}}
\newcommand{\novo}[1]{\emph{#1}}
\newcommand{\eer}{Redução do Erro Esperado\xspace}
\newcommand{\elms}{Máquinas Extremas\xspace}
\newcommand{\elm}{Máquina Extrema\xspace}

\newcommand{\tarefa}[1] {\addcontentsline{toc}{section}{\green{\textbf{#1}}}}
