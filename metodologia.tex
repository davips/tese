...
\subsection{Métricas}
Um cara que usa log no eixo X e usa ``Area under the Learning Curve'':
...
Assim, deve ser definido um momento na curva de aprendizado como sendo o orçamento
disponível e deve ser avaliado o modelo induzido até então.
