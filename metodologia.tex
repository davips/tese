\chapter{Metodologia (ou Experimentos?))}\label{cap:metodologia}
\ano{apresenta dados comuns a todos os experimentos: descrição dos datasets e
highlights(muitas classes etc.), classificadores empregados, método de validação cruzada}

Foi empreendida uma avaliação experimental para comprovação empírica das contribuições
citadas no Capítulo \ref{cap:contrib} \ano{<- rever}.
