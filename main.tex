...
\newcommand{\meuorientador}{Prof. Dr. AndrÃ© Carlos Ponce de Leon Ferreira de Carvalho}
...
%%\usepackage{epigraph}
%%\usepackage{endnotes}
%\renewcommand{\notesname}{ComentÃ¡rios}
\usepackage{natbib}
\usepackage{latexsym}
\usepackage{setspace}
\usepackage{xspace}
% \usepackage[nohyperlinks]
%%% referencias com pÃ¡gina \vref
\usepackage[brazil]{varioref}
\usepackage{indentfirst}
%%% figuras um ao lado do outro
\usepackage{subfigure}
%%% definir tÃ­tulos de seÃ§Ã£o
...
%%% comentar as linhas na versÃ£o para impressao
...
\include{macros}
% \usepackage{parallel} % para as equaÃ§Ãµes de medidas multilabel

%%%%%%%%%%%%%%%% FORMATACAO DE PALAVRAS %%%%%%%%%%%%%%%%%%%%%

\newcommand{\nf }[1] % nome de ferramenta
    {\textsc{#1}}
\newcommand{\pe }[1] % termo em inglÃªs
    {\textit{#1}}
...
\newcommand{\nota}{Tese apresentada ao Instituto de CiÃªncias MatemÃ¡ticas e de ComputaÃ§Ã£o - ICMC-USP, para o Exame de QualificaÃ§Ã£o, como parte dos requisitos necessÃ¡rios Ã  obtenÃ§Ã£o do tÃ­tulo de \meugrau\xspace em CiÃªncias de ComputaÃ§Ã£o e MatemÃ¡tica Computacional.}
%\newcommand{\nota}{Monografia apresentada Ã  disciplina de Metodologia de Pesquisa CientÃ­fica em InteligÃªncia Artificial, no Instituto de CiÃªncias MatemÃ¡ticas e de ComputaÃ§Ã£o - ICMC-USP, como parte dos requisitos necessÃ¡rios Ã  obtenÃ§Ã£o dos crÃ©ditos relacionados Ã  disciplina.}
...
% $d(\bm{x},\bm{u})$ medida de distÃ¢ncia
