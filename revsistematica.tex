...
Primário: fazer uma prospecção da área em busca das estratégias existentes para o cenário baseado em banco de exemplos (pool-based) uma-query-por-vez-e-a-respeito-da-classe monorótulo, com oráculo único, consistente e os exemplos têm custos uniformes com distribuição estacionária.
