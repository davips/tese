...
é introduzido nas seções \ref{aprendizado-ativo} e \ref{estrategias}.
...
aprendizado ativo e pelo desenvolvimento de uma estratégia específica para ela (Capítulo \ref{proposta}).
