...
\cite{brazdil1994analysis} faz tabela de distâncias pareadas com taxas de erro sendo
as dimensões, depois faz decomposição ortogonal para visualizar em duas dimensões.
Depois faz agrupamento hierárquico.

\esb{distEntrePassivas.scala deve usar kappa? deve ser normalizado?}
