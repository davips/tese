...
todos os demais (entre $0,28$ e $0,30$) - com exceção do acerto majoritário
que se afasta dos demais por ser muito inferior em quase todas as bases.
...
Por outro lado, os três pares de algoritmos, apesar de similares,
...
têm um grau de similaridade acima da média (valor de $0,66$ para as duas agnósticas e
entre $0,43$ e $0,57$ para as restantes).
...
Por esse motivo e pela equivalência nas medidas de acurácia
listadas nas tabelas \ref{} \ano{criar tabelas com dados de todas as 21 estrats no apêndice},
optou-se por excluir dos experimentos
as propostas baseadas na utilidade de cada classe.
As estratégias remanescentes baseadas na distância de Manhattan
(TUman e ATUman) também foram excluídas
por serem excessivamente similares às estratégias baseadas na distância euclidiana.
