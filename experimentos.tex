...
e seus resultados.
Na Seção \ref{prep}, é definido o subconjunto de estratégias e aprendizes mais relevantes
...
\ano{colocar svm na tabela e dizer que foi excluído por ter ido muito ruim ou deixar?
prov devido à necessidade de ajuste de parâmetros}

\esb{quando a pessoa não sabe que classificador é adequado à base,
...
escolher o melhor classificador de forma mais apropriada.}
...
\ano{apesar de passiva, essa é a acurácia com treinamento incremental, desde
|Y| um a um até |U| para os algs CIELM,IELM,NB e VFDT; talvez por isso o
desempenho tenha sido pior}
