...
\begin{table}[h]
\caption{Similaridade entre algoritmos de aprendizado de acordo com a acurácia balanceada.
...
% \input stratDists
\begin{table}[h]
\caption{Similaridade entre estratégias de acordo com a medida ALC-kappa.
