...
\end{itemize}
Outra condição é que a sequência de consultas não é necessariamente ótima,
pois nenhuma das estratégias implementadas
tira proveito da informação sobre o orçamento disponível.
Essa possibilidade, mai teórica do que prática,
decorre do fato do processo ativo de amostragem não ser uma
\textit{cadeia de Markov} de primeira ordem, ou seja,
a consulta ótima depende de quantas ainda podem ser feitas \citep{conf/icml/RoyM01}.
