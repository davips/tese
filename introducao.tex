...
\blue{a revisão sist. não chegou a lugar algum, talvez não compense dedicar um capítulo inteiro a
ela}

\blue{tenho uns 50 artigos de uma busca sem foco no tema que a tese passou a ter; pode ser útil
pra mostrar uma busca sistemática de estratégias na literatura}

Revisão bibliográfica sistemática é um procedimento de identificação,
