...
\ano{\citep{journals/jmlr/GuyonCDL11} tem o gráfico mostrando muita gente usando unc sampling
...
\end{itemize}
Outra característica está no desconhecimento do orçamento disponível por parte das estratégias implementadas.
